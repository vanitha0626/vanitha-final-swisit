...
/**
 * Class to test master scanner service
 */
@RunWith(SpringJUnit4ClassRunner.class)
@WebAppConfiguration
@ContextConfiguration()
public class MasterScannerServiceImplTest {
    @MockBean
    ...
    @Test
    public void scanDocument() throws ParseException, JsonProcessingException {
        SearcherResult searcherResult = new SearcherResult();
        searcherResult.setConcept("Aggregation");
        searcherResult.setLink("http://javarevisited.blogspot.com/2014/02/ifference-between-association-vs-composition-vs-aggregation.html");
        searcherResult.setSnippet("Both Composition and Aggregation are the form of association between two \n" +
                "objects, but ... Composition vs Association vs Aggregation in Java.");
        searcherResult.setTitle("Difference between Association, Composition and Aggregation in Java, UML and Object Oriented Programming");
        ...
        Assert.assertEquals("Aggregation", crawlerResult.getConcept());
        Assert.assertEquals("http://javarevisited.blogspot.com/2014/02/ifference-between-association-vs-composition-vs-aggregation.html",crawlerResult.getLink());
        Assert.assertEquals("Both Composition and Aggregation are the form of association between two \n" +
                "objects, but ... Composition vs Association vs Aggregation in Java.",crawlerResult.getSnippet());
        Assert.assertEquals("Difference between Association, Composition and Aggregation in Java, UML and Object Oriented Programming",crawlerResult.getTitle());
        String document1 = document.toString();
        Assert.assertEquals(document1,crawlerResult.getDocument());
        Assert.assertEquals(new SimpleDateFormat("dd/MM/yyyy").parse("10/07/2017"),crawlerResult.getLastindexedof());
    }
}
